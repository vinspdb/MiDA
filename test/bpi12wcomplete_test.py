...
for f in range(3):
    # train views
    outfile2 = open("bpi12wcompletemodel_verifica.txt", 'a')
    ...
    model = load_model("models/bpi12wcompletemodel_smac_"+str(f)+"_batch.h5")
    ...
    print(confusion_matrix(Y_test_int, preds_a))
