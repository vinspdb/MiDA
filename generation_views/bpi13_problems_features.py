...
if __name__ == "__main__":
    ...
    for fold in range(n_folds):
        info_dataset = []
        train_data_name = "fold/bpi13_problems/" + str(benchmark) + "_kfoldcv_" + str(fold) + "_train.csv"
        test_data_name = "fold/bpi13_problems/" + str(benchmark) + "_kfoldcv_" + str(fold) + "_test.csv"

        df_train = pd.read_csv(train_data_name, sep=',', encoding='cp1252',header=None)
        df_test = pd.read_csv(test_data_name, sep=',', encoding='cp1252',header=None)

        df_train.columns = ['Case ID', 'Activity', 'Resource', 'Timestamp', 'Att1', 'Att2', 'Att3', 'Att4', 'Att5', 'Att6']
        df_test.columns = ['Case ID', 'Activity', 'Resource', 'Timestamp', 'Att1', 'Att2', 'Att3', 'Att4', 'Att5', 'Att6']
        ...
        print(len(mapping_att1))
        print(len(mapping_att2))
        print(len(mapping_att3))
        print(len(mapping_att4))
        print(len(mapping_att5))
        print(len(mapping_att6))
        ...
        np.save("fold/bpi13_problems/" + str(benchmark) + "_act_" + str(fold) + "_train.npy", sequence_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_res_" + str(fold) + "_train.npy", resource_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_diff2_" + str(fold) + "_train.npy", diff2_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att1_" + str(fold) + "_train.npy", list_att1_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att2_" + str(fold) + "_train.npy", list_att2_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att3_" + str(fold) + "_train.npy", list_att3_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att4_" + str(fold) + "_train.npy", list_att4_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att5_" + str(fold) + "_train.npy", list_att5_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att6_" + str(fold) + "_train.npy", list_att6_train)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_y_" + str(fold) + "_train.npy", y_train)

        np.save("fold/bpi13_problems/" + str(benchmark) + "_act_" + str(fold) + "_test.npy", sequence_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_res_" + str(fold) + "_test.npy", resource_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_diff2_" + str(fold) + "_test.npy", diff2_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att1_" + str(fold) + "_test.npy", list_att1_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att2_" + str(fold) + "_test.npy", list_att2_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att3_" + str(fold) + "_test.npy", list_att3_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att4_" + str(fold) + "_test.npy", list_att4_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att5_" + str(fold) + "_test.npy", list_att5_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_att6_" + str(fold) + "_test.npy", list_att6_test)
        np.save("fold/bpi13_problems/" + str(benchmark) + "_y_" + str(fold) + "_test.npy", y_test)

    info_dataset = np.asarray(info_dataset)
    np.save("fold/bpi13_problems/" + str(benchmark) + "_info_dataset.npy", info_dataset)
