...
if __name__ == "__main__":
    ...
    for fold in range(n_folds):
        info_dataset = []
        train_data_name = "fold/bpi12_work_all/" + str(benchmark) + "_kfoldcv_" + str(fold) + "_train.csv"
        test_data_name = "fold/bpi12_work_all/" + str(benchmark) + "_kfoldcv_" + str(fold) + "_test.csv"
        ...
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_act_" + str(fold) + "_train.npy", sequence_train)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_res_" + str(fold) + "_train.npy", resource_train)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_diff2_" + str(fold) + "_train.npy", diff2_train)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_amount_" + str(fold) + "_train.npy", qt_train)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_y_" + str(fold) + "_train.npy", y_train)

        np.save("fold/bpi12_work_all/" + str(benchmark) + "_act_" + str(fold) + "_test.npy", sequence_test)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_res_" + str(fold) + "_test.npy", resource_test)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_diff2_" + str(fold) + "_test.npy", diff2_test)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_amount_" + str(fold) + "_test.npy", qt_test)
        np.save("fold/bpi12_work_all/" + str(benchmark) + "_y_" + str(fold) + "_test.npy", y_test)
        

    info_dataset = np.asarray(info_dataset)
    np.save("fold/bpi12_work_all/" + str(benchmark) + "_info_dataset.npy", info_dataset)
