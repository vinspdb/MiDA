...
for f in range(3):
    # train views
    outfile2 = open("pretrainedbpi13_problemsmodel_smac_verifica.txt", 'a')
    ...
    model = load_model("models/bpi13_problemsmodel_smac_"+str(f)+"_batch.h5")
    preds_a = model.predict([diff2_test, sequence_test, resource_test, att1_test, att2_test, att3_test, att4_test, att5_test, att6_test])
